...
export default function IssueCard (){
    return (
        <div className="w-3/5 max-w-full p-2.5 m-1.5 bg-white rounded-lg border-none shadow-md">
  
    
      <div key=/*{card._id}*/ className="mb-4 bg-white shadow-lg rounded-lg p-4">
        <div className="flex items-center gap-2.5">
          <img
            ...
            alt="Profile"
          />
          <h2 className="text-xs font-semibold">/*{card.username}*/</h2>
        </div>
        <div className="my-2">
          <h2 className="text-xl font-semibold text-purple-700">/*{card.title}*/</h2>
          <p className="py-1">/*{card.description || card.discreption}*/</p>
          <img
